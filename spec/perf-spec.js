...
/***/ function(module, exports, __webpack_require__) {
	...
	var conway, thatIt, paulCallahansPattern;
	conway = __webpack_require__(7);
	thatIt = it;
	paulCallahansPattern = "XXX-X\nX----\n---XX\n-XX-X\nX-X-X";
	describe("conway performance", function(){
	  return thatIt("computes a paul callahans infinite pattern to the 1000th tick in less than 20 seconds", function(){
	    var timeStart, p, i$, x;
	    timeStart = new Date;
	    p = conway.read(paulCallahansPattern);
	    for (i$ = 0; i$ <= 1000; ++i$) {
	      x = i$;
	      p = conway.tick(p);
	    }
	    return expect(new Date - timeStart).toBeLessThan(15 * 1000);
	  });
	});
	//# sourceMappingURL=C:\Users\Florian\Desktop\work\conway-game-of-life\node_modules\livescript-loader\index.js!C:\Users\Florian\Desktop\work\conway-game-of-life\spec\perf-spec.ls.map
